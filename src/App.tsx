...
const CapsuleLibrary = lazy(() => import("./pages/CapsuleLibrary"));
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <h1 className="text-xl font-serif font-medium mb-2">Initializing Living Heirloom</h1>
          <p className="text-muted-foreground">Setting up your personal legacy space...</p>
        </div>
      </div>
    );
  }
